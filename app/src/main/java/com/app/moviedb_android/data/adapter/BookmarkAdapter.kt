...
class BookmarkAdapter(private val context:Context, private val bookmarks: ArrayList<Bookmark>): RecyclerView.Adapter<BookmarkAdapter.CardHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BookmarkAdapter.CardHolder {
